...
export function AllProjectsView({ isOpen, onClose, allProjects, onProjectClick }: AllProjectsViewProps) {
  useEffect(() => {
    if (isOpen) {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-4 md:inset-8 z-50 bg-white overflow-hidden rounded-lg"
          >
            {/* Header */}
