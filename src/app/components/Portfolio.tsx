...
export function Portfolio() {
  ...
  try {
    const res = await fetch(
      `https://${projectId}.supabase.co/functions/v1/make-server-be0083bc/projects`,
      {
        headers: {
      ...
      bg-clip-text text-transparent">SELECTED WORK</h2>
        ...
        <div className="text-center">
          <button
            ...
            className="inline-flex items-center gap-2 px-8 py-3 bg-black text-white hover:bg-gray-800 transition-colors group translate-y-4"
          >
            View All Projects
